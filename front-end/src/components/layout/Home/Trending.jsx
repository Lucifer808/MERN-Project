...
const SlifeStockWrapStyled = styled.div`
    border: 1px solid lightgray;
    width: 240px;
    border-radius: 10px;
    margin-top: 10px;
`
const SlideStockStyled = styled.div`
    height: 10px;
    width: 60%;
    background-color: #fcb800;
    border-radius: 10px;
`
const SlideSoldStyled = styled.div`
    margin-top: 10px;
    font-size: 14px;
`
    ...
    return (
        <>
            <Container id='trending'>
                <SlideContainer>
                    <HeadingStyled>
                        <HeadingTitleStyled>Sản phẩm bán chạy nhất trong ngày</HeadingTitleStyled>
                    ...
                    <Slider {...settings}>
                        <Wrapper>
                            ...
                            <SlifeStockWrapStyled>
                                <SlideStockStyled />
                            </SlifeStockWrapStyled>
                            <SlideSoldStyled>Đã bán: 20</SlideSoldStyled>
                            <SaleOffStyled>
